...
class PurchasedVideoBaseViewController: SlideMenuController{
    
    override func awakeFromNib() {
        mainViewController = R.storyboard.purchasedVideo().instantiateInitialViewController()
